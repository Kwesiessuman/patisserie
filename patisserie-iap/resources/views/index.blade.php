...
<head>
	<meta charset="utf-8">
	<title>Home|La Pâtisserie</title>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<h1>LA PÂTISSERIE</h1>
				<a href="href={{ url('/login') }} class="smoothScroll btn btn-default">ENGAGE YOUR TASTE BUDS</a>
			</div>
		</div>
	</div>		
</section>
		...
		<div class="row">
			<div class="col-md-4 col-sm-4 wow fadeInUp" data-wow-delay="0.6s">
				...
				<div class="address">
					...
					<h4>Yaya Centre, Nairobi, Kenya</h4>
				</div>
			</div>
			<div class="col-md-4 col-sm-4 wow fadeInUp" data-wow-delay="0.6s">
				<h2 class="heading">Open Hours</h2>
					<p>Mon-Fri <span>9:00 AM - 9:00 PM</span></p>
					<p>Sat &amp; Sun  <span>11:30 AM - 10:00 PM</span></p>
			</div>
			<div class="col-md-4 col-sm-4 wow fadeInUp" data-wow-delay="0.6s">
